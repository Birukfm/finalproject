...
import 'package:imgmt_test1/pages/PurchasedInsurance.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class PurchasedInsurance1 extends StatelessWidget {
  PurchasedInsurance1({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 164.0, middle: 0.5227),
            Pin(size: 40.0, middle: 0.2483),
            child: Text(
              'Automobile ',
              style: TextStyle(
                fontFamily: 'Segoe UI',
