...
import 'package:imgmt_test1/pages/PhoneVerification1.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:imgmt_test1/pages/HomePage.dart';
import 'package:flutter_svg/flutter_svg.dart';

class PhoneVerification2 extends StatelessWidget {
  PhoneVerification2({
    Key? key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => PhoneVerification1(),
                ),
              ],
              child: Text.rich(
                TextSpan(
