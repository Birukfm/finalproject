...
import 'package:imgmt_test1/pages/Quote.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 41.0, end: 55.0),
            Pin(size: 33.0, middle: 0.2452),
            child: Text(
              'Choose which pertains to you.',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 25,
                color: const Color(0xff000000),
          ...
          Pinned.fromPins(
            Pin(size: 6.0, middle: 0.4763),
            Pin(size: 27.0, start: 56.0),
            child: Text(
              ' ',
              style: TextStyle(
                fontFamily: 'Segoe UI',
          ...
          Pinned.fromPins(
            Pin(start: 21.0, end: 10.0),
            Pin(size: 36.0, middle: 0.4056),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
