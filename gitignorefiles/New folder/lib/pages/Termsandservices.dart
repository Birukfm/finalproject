    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 61.0, middle: 0.2207),
            Pin(size: 27.0, middle: 0.7798),
            child: Text(
              'I agree',
              style: TextStyle(
                fontFamily: 'Segoe UI',
          ...
          Pinned.fromPins(
            Pin(size: 115.0, middle: 0.2588),
            Pin(size: 27.0, end: 154.0),
            child: Text(
              'I Don\'t agree',
              style: TextStyle(
                fontFamily: 'Segoe UI',
